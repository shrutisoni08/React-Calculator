    ...
    <div className="flex flex-col md:flex-row items-center justify-center w-[80%] h-[90vh] bg-gradient-to-r from-[#E0F7FA] to-[#B2EBF2] px-6 dark:bg-gray-900">
      ...
      <div className="w-full md:w-3/4 flex flex-col items-center justify-center p-6">
        <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-xl p-8 w-full max-w-md">
          <h2 className="text-3xl font-bold text-[#0CCCCC] mb-6 text-center dark:text-[#0CCCCC]">Calorie Calculator</h2>
          ...
          <div className="space-y-4">
            ...
            <label className="block">
              <span className="text-gray-700 dark:text-gray-300">Height (cm):</span>
              <input 
                type="number" 
                value={height} 
            ...
            <label className="block">
              <span className="text-gray-700 dark:text-gray-300">Activity Level:</span>
              <select 
                value={activity} 
          ...
          <div className="mt-6 flex flex-wrap gap-4 justify-center">
            <button onClick={calculateCalories} className="px-6 py-3 bg-[#0CCCCC] text-white font-bold rounded-lg shadow-md hover:bg-[#9C27B0] transition">
              Calculate
            </button>
            <button onClick={undo} className="px-6 py-3 bg-gray-400 text-white font-bold rounded-lg shadow-md hover:bg-gray-500 transition">
              Undo
            </button>
            <button onClick={redo} className="px-6 py-3 bg-gray-400 text-white font-bold rounded-lg shadow-md hover:bg-gray-500 transition">
              Redo
            </button>
          </div>
          ...
          {calories && (
            <p className="mt-6 text-xl text-center font-semibold text-gray-800 dark:text-gray-300">
              Daily Calorie Needs: <span className="text-[#6A1B9A] dark:text-[#AB47BC]">{calories}</span> kcal
            </p>
          )}
        </div>
      </div>
